...
![4.10_structure_app_engine](./img/4.10_structure_app_engine.png)
...
![4.11_create_kubernetes_engine](./img/4.11_create_kubernetes_engine.png)
...
![5.3_create_billing_account](./img/5.3_create_billing_account.png)
...
![5.4_create_VM](./img/5.4_create_VM.png)

**그림 5.4** VM을 생성하기 위한 첫 화면

VM 설정을 가져오기 위해 화면에서 Create 버튼을 클릭한다.(그림 5.5)

![5.5_create_vm_compute_engine](./img/5.5_create_vm_compute_engine.png)
...
![5.6_regions](./img/5.6_regions.png)
...
![5.10_id_api_firewall](./img/5.10_id_api_firewall.png)
...
![5.11_management_tab](./img/5.11_management_tab.png)
...
![5.12_management_tab_second](./img/5.12_management_tab_second.png)
...
![5.13_security_tab](./img/5.13_security_tab.png)
...
![5.14_boot_disk_advanced](./img/5.14_boot_disk_advanced.png)
...
![5.15_adding_disk](./img/5.15_adding_disk.png)
...
![5.16_adding_new_disk](./img/5.16_adding_new_disk.png)
...
![5.17_network_configuration](./img/5.17_network_configuration.png)
...
![5.18_sole_tenancy](./img/5.18_sole_tenancy.png)
...
![5.19_cloud_shell](./img/5.19_cloud_shell.png)
...
![5.20_cloud_shell_open](./img/5.20_cloud_shell_open.png)
...
![5.21_basic_operation_VM](./img/5.21_basic_operation_VM.png)
...
![5.22_ssh_session](./img/5.22_ssh_session.png)
...
![5.23_new_browser_window](./img/5.23_new_browser_window.png)
...
![5.24_monitoring_tab_vm](./img/5.24_monitoring_tab_vm.png)

**그림 5.24** VM인스턴스 상세 페이지의 모니터링 탭은 CPU 이용을 보여준다.

![5.25_monitoring_network](./img/5.25_monitoring_network.png)

**그림 5.25** VM 인스턴스 상세 페이지의 모니터링 탭은 네트워크 이용에 대해 보여준다.

![5.26_monitoring_disk](./img/5.26_monitoring_disk.png)
